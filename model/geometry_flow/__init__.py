...
class Flow(TransArticulatedBaseModule):
    def __init__(self, config):
        ...
        try:
            self.ali = GeometryVAE.load_from_checkpoint(self.e_config['sdf_model_path'])
            ...
            self.ali = GeometryVAE(sdf_config_content)
        self.ali.eval()
    ...
    def step(self, batch, batch_idx):
        ...
        diff_loss_1, diff_100_loss_1, diff_1000_loss_1, pred_latent_1, perturbed_pc_1 =   \
            self.models.geometry_flow_model_from_latent(z, cond={
                'z_hat': z_conditions,
    ...
    def validation_step(self, batch, batch_idx):
        ...
        for z in [pred_latent_1, z]:
            ...
            batched_recon_latent = self.ali.vae_model.decode(z) # reconstruced triplane features
